...
public class ComentarioController {
	...
	public static List<Comentario> getComentario(int idImagen){
		...
		String sql ="SELECT id_imagen,fecha,usuario,comentario FROM comentario_img "
				+ "JOIN usuario ON comentario_img.id_emisor=usuario.id_usuario WHERE id_imagen='"+idImagen+"'";
